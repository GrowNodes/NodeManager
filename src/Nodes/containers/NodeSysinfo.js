...
class NodeSysinfo extends Component {
    static contextTypes = {
    ...
    render () {
        ...
        return (
            <div>
                <Link to={`/nodes/${this.props.params.node_id}`}>Back to Node</Link><br/>
...
export default connect(mapStateToProps, null)(NodeSysinfo);